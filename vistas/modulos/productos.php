      ...
      <section class="content">
        <div class="box">
          <div class="box-header with-border">
            ...
            <button class="btn btn-info" data-toggle="modal" data-target="#modalAgregarInventario">
              Agregar Inventario
            </button>
          </div>
          <div class="box-body">
        ...
        <div class="modal-content">
          <form role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-header" style="background:#3c8dbc; color:white">
              ...
              <h4 class="modal-title">Registro Inventario</h4>
            </div>
            <!--=====================================
            CUERPO DEL MODAL
            ======================================-->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <select class="form-control input-lg" id="InventarioProducto" name="InventarioProducto" required>
                ...
                <!-- ENTRADA INGRESO EGRESO -->
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-product-hunt"></i></span> 
                    <label for="IngresoEgreso" class="form-control input-lg">
                      Ingreso
                      <input type="radio" name="IngresoEgreso" value="0" checked>
                    </label>
                    <label for="IngresoEgreso" class="form-control input-lg">
                      Egreso
                      <input type="radio" name="IngresoEgreso" value="1">
                    </label>
                  </div>
                </div>
                <!-- ENTRADA CANTIDAD STOCK -->
                <div class="form-group">
                  <div class="input-group">
            ...
            <?php
              $registrarInventario = new ControladorProductos();
              $registrarInventario -> ctrRegistrarInventario();
            ?>  
        </div>
      </div>
    </div>
